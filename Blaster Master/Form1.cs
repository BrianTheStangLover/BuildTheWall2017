...
namespace BlasterMaster
{
    ...
    public partial class Form1 : Form
    {
        ...
        private clsPlayerBullet[,] playerbullet = new clsPlayerBullet[501, 20];
                                    ...
                                    if (!invaders[(i + invaderBatchStartIndex) + (j * 6)].isShooting())
                                    {
                                        switch (j)
                                        {
                                            case 0:
                                                ...
                                                {
                                                    invaders[i + invaderBatchStartIndex].setDoShooting(false);
                                                    tShootersInPath += 1;
                                                }
                                            ...
                                            case 1:
                                                ...
                                                {
                                                    invaders[(i + invaderBatchStartIndex) + (j * 6)].setDoShooting(false);
                                                    tShootersInPath += 1;
                                                }
            ...
            if (!player.isDead())
            {
                ...
                if (tScales.getTAcaleC() == 0)
                {
                    ...
                    if (j > 5)
                    {
                        ...
                        {
                            // Invoke shoot method
                            invaders[e].setDoShooting(false);
                                    ...
                                    if (playerbullet[i, 0] == null)
                                    {
                                        switch (player.getFirePowerLevel())
                                        {
                                            case 1: //:: x1 fire ::
                                                ...
                                                playerbullet[i, 0] = new clsPlayerBullet(x - 2, y); //Liiiiit Dude!
        ...
        private void doEndOfLevel()
        {
            ...
            if (genWorkingCounter < 100)
            {
               ...
               // Text ...
               DrawText(graphicsBuffer, "Wall Layer Complete!", 180, 328, 22, FontStyle.Bold, Brushes.Black);
               DrawText(graphicsBuffer, "Wall Layer Complete!", 181, 330, 22, FontStyle.Bold, Brushes.Red);
            }
